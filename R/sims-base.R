...
#' @param month_composition A number between 1 and 12 of the caribou month that composition survey occurs.
...
#' @param groups_year A vector of length nyear of the number of groups in the census.
