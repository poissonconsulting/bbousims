...
$$
\text{logit}(Survival_{y,m}) \sim \beta_0 + \beta_Y \cdot Year_{y} + \beta_{A_{y}} + \beta_{M_{m}} + \beta_{AM_{y,m}}
$$
...
$$
\text{logit}(Fecundity_{y,m}) \sim \beta_0 + \beta_Y \cdot Year_{y} + \beta_{A_{y}}
$$
