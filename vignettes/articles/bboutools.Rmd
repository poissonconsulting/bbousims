...
Recruitment and survival data that are the output of `bbs_simulate_caribou()` are formatted to be used as input for `bboutools` model fitting functions. 
...
First we set up a stable population with annual variation in adult female survival and recruitment and generate three simulated datasets for illustration. 
...
The true recruitment rates can be calculated from the projected population at each composition survey month.
```{r}
month_composition = 9L
