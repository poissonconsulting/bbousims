...
In this case, fits for each simulated data set contain the actual value in the 95% CI. 
...
actual <- tibble(CaribouYear = 1:length(recruitment), actual = recruitment)
```
...
fits_recruitment <- map(1:nsims, function(x){
  ...
  bboutools::bb_fit_recruitment(data = recruitment, 
                             year_start = 1L, 
                             quiet = TRUE, 
                             nthin = 100, 
                             niters = 500)
