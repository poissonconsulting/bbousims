...
Monthly survival and annual fecundity rates are simulated from a set parameters including intercept, trend, standard deviation of annual variation, standard deviation of monthly variation and standard deviation of monthly within annual variation.  

Population is projected from survival, ageing and birth processes. 
Survival occurs at the end of each month and survival, ageing and birth occur at the end of each year, in that order.  

Key sampling parameters include month of composition survey and collaring, mean group size, minimum group size, maximum group size (as proportion of total population) and proportion of groups observed.
Group sizes are generated stochastically and individuals are assigned randomly to groups until they are filled.  

## Simulate Boreal Caribou population abundance
